...
#         x, y = button.pos
#         w, h = button.size
#         cv.rectangle(img, button.pos, (x + w, y + h), (255, 0, 0), cv.FILLED,cv.LINE_AA,30)
...
#                         cv.rectangle(img, button.pos, (x + w, y + h), (150, 60, 0), cv.FILLED,cv.LINE_AA,30)
#                         cv.putText(img, button.text, (x + 20, y + 65), cv.FONT_HERSHEY_PLAIN, 4, (255, 255, 255), 4)
...
#                         # print(length)
#                         if length < 30:
#                             cv.rectangle(img,button.pos, (x+w,y+h), (0,255,0),cv.FILLED,cv.LINE_AA,30)
#                             cv.putText(img,button.text,(x + 20, y + 65),cv.FONT_HERSHEY_PLAIN,4,(255,255,255),4)
